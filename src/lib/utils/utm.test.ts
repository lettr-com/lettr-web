...
describe("getUtmParamsFromCookie", () => {
  it("parses utm values from cookie", () => {
    const cookie = "lettr_utm=utm_source%3Dgoogle%26utm_medium%3Dcpc%26foo%3Dbar; theme=dark";
...
describe("buildRegisterUrl", () => {
  it("returns register url with utms from URL", () => {
    ...
    expect(buildRegisterUrl(url, "")).toBe(
      "https://app.lettr.com/register?utm_source=google&utm_medium=cpc",
    );
  });
