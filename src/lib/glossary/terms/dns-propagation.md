...
With [Domain Connect](/glossary/domain-connect/) on Cloudflare, propagation typically completes within a few minutes of applying the records. If verification fails immediately afterwards, the docs advise waiting a minute or two and trying again, because Cloudflare applies records instantly but external DNS queries can take a short time to see them.
